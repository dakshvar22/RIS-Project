...
dnum int NOT NULL,
hodId int,
constraint pk_department PRIMARY KEY (dnum,hodId)
);
...
labname varchar(20),
labNum int NOT NULL,
constraint pk_dlabs PRIMARY KEY(dno,labNum)
);
...
profDept int NOT NULL,
constraint  pk_professor PRIMARY KEY(profId,profdept)
);
...
plab int NOT NULL,
constraint pk_project PRIMARY KEY(projId,headId,projDept,plab)
);
